    ...
    <div class="form-group col-sm-12">
        <div class="row">
            <div class="mylabel col-sm-3">
                {!! Form::label('employee_id', 'Felhasználó:') !!}
            </div>
...
<div class="form-group col-sm-4">
    <div class="form-group col-sm-12">
        <div class="row">
            <div class="mylabel col-sm-2">
                {!! Form::label('rendszergazda', 'Státusz:') !!}
            </div>
            <div class="mylabel col-sm-10">
        ...
        $(function () {
            ...
            $('#saveBtn').click(function (e) {
                ...
                if ( parseInt(employeeId) == 0) {
                    swMove("Nem adott meg felhasználót!");
                    e.preventDefault();
                    $('#employee_id').focus();
                    return false;
                } else {
                    if ( email.length == 0) {
                        swMove("Nem adott meg email címet!");
                        e.preventDefault();
                        $('#email').focus();
                        return false;
                    } else {
                        if ( parseInt(rendszergazda) == 0) {
                            swMove("Nem adott meg státuszt!");
                            e.preventDefault();
                            $('#rendszergazda').focus();
                            return false;
                        }
