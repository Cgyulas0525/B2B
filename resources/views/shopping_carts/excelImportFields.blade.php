...
<div class="form-group col-lg-2">
    <div class="row">
        ...
        <h4>
            <div>
                <p style="text-align: center;">Kérem rakja az oszlopokat a következő sorrrendbe:</p>
                <p style="text-align: center;">Kód</p>
                <p style="text-align: center;">Mennyiség</p>
            </div>
        </h4>
    </div>
</div>
<div class="col-lg-10 col-md-12 col-xs-12 topmargin2em">
    ...
    <h4>Rekord: <a id="rekord"> </a> Felfolgozott: <a id="feldolgozott"> </a> </h4>
</div>
