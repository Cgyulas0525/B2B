    ...
    <div class="form-group col-sm-12">
        <div class="row">
            <div class="mylabel8 col-sm-2">
                {!! Form::label('customercontact_id', 'Termék kategória:', ['class'=>'font20px']) !!}
            </div>
            ...
            <div class="mylabel8 col-sm-2">
                <a href="#" class="btn btn-dark mind" title="Minden termék"><i class="fas fa-warehouse"></i></a>
                <a href="#" class="btn btn-primary kedvenc" title="Kedvenc"><i class="fas fa-hand-holding-heart"></i></a>
            </div>
        </div>
    </div>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            table = $('.partners-table').DataTable({
                ...
                columns: [
                    {title: 'Termék', data: 'Name', name: 'Name'},
                ],
                buttons: [],
