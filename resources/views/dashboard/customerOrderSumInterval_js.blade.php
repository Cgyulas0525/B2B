<script type="text/javascript">
    $(function () {
        ...
        var chart_customerOrderSumInterval = highchartLine( 'customerOrderSumInterval', 'line', 320, LineChartKategoria(coi), LineChartData(coi, ''), 'Megrendelés darab az elmúlt 12 hónapban', 'havi bontás', 'darab');
